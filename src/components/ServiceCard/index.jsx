...
import { ScrollTrigger } from "gsap/ScrollTrigger";import { Box, Typography, Button, Grid, Paper, TextField, Card, CardMedia, Accordion, AccordionActions, AccordionSummary, AccordionDetails } from '@mui/material';
...
const ServicesCards = () => {
  ...
  return (
    <div style={{width:'100%',display: "flex", justifyContent: 'center'}}>
      <Box className="main_services" sx={{ width: { xs: '100%', md: '90%', lg: '100%' } }} justifyContent="center" >
